...
void encoderInit(void)
{
	...
	// enable interrupts
	sbi(IMSK, ENC0_INT);	// IMSK is auto-defined in encoder.h
#endif
#ifdef ENC1_SIGNAL
	// set interrupt pins to input and apply pullup resistor
	...
	// enable interrupts
	sbi(IMSK, ENC1_INT);	// IMSK is auto-defined in encoder.h
#endif
#ifdef ENC2_SIGNAL
	// set interrupt pins to input and apply pullup resistor
	...
	// enable interrupts
	sbi(IMSK, ENC2_INT);	// IMSK is auto-defined in encoder.h
#endif
#ifdef ENC3_SIGNAL
	// set interrupt pins to input and apply pullup resistor
	...
	// enable interrupts
	sbi(IMSK, ENC3_INT);	// IMSK is auto-defined in encoder.h
#endif
...
void encoderOff(void)
{
	...
	//sbi(IMSK, ENC0_INT);	// IMSK is auto-defined in encoder.h
	cbi(IMSK, ENC0_INT);	// IMSK is auto-defined in encoder.h
	...
	//--S [] 2014/07/23: Sang-Wook Lee
	//sbi(IMSK, ENC1_INT);	// IMSK is auto-defined in encoder.h
	cbi(IMSK, ENC1_INT);	// IMSK is auto-defined in encoder.h
	//--E [] 2014/07/23: Sang-Wook Lee
#endif
#ifdef ENC2_SIGNAL
	// disable interrupts
	//--S [] 2014/07/23: Sang-Wook Lee
	//sbi(IMSK, ENC2_INT);	// IMSK is auto-defined in encoder.h
	cbi(IMSK, ENC2_INT);	// IMSK is auto-defined in encoder.h
	//--E [] 2014/07/23: Sang-Wook Lee
#endif
#ifdef ENC3_SIGNAL
	// disable interrupts
	//--S [] 2014/07/23: Sang-Wook Lee
	//sbi(IMSK, ENC3_INT);	// IMSK is auto-defined in encoder.h
	cbi(IMSK, ENC3_INT);	// IMSK is auto-defined in encoder.h
	//--E [] 2014/07/23: Sang-Wook Lee
#endif
}
