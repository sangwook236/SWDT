...
void main()
{
	int i;
	// Anode.
	unsigned int str[] = {0xc0,0xf9,0xa4,0xb0,0x99,0x92,0x82,0xf8,0x80,0x90,0x88,0x83,0xc6,0xa1,0x86,0x8e};
...
{
	const uint8_t str_7segment_anode[] = {
	...
	while (1)
	{
		...
		{
			PORTC = 0x00;
			PORTA = str_7segment_anode[display_num[j]];
			PORTC = 0x01 << j;
