...
% Valid values include: 'SAD', 'LSAD', 'ZSAD', 'SSD', 'LSSD', 'ZSSD', 'NCC', 'ZNCC'
% Outputs:
% 1. Disparity Map (var: dispMap),
% 2. Time taken (var: timeTaken)
% Example Usage of Function: [dispMap, timeTaken]=denseMatch('tsukubaleft.jpg', 'tsukubaright.jpg', 9, 0, 16, 'ZNCC');
% *************************************************************************
