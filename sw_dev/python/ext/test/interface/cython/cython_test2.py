...
def cython_tutorial():
	import cython_lib.helloworld as helloworld

	import cython_lib.primes_c as primes_c
	import cython_lib.primes_cpp as primes_cpp
...
def c_standard_lirary():
	import cython_lib.pyclibrary as pyclibrary
...
def cpp_standard_lirary():
	import cython_lib.pycpplibrary as pycpplibrary
...
def cpp_function_example():
	import cython_lib.pyarithmetic as pyarithmetic
...
def cpp_class_example():
	import cython_lib.pyrectangle as pyrectangle
...
# REF [site] >> http://docs.cython.org/en/latest/src/userguide/wrapping_CPlusPlus.html
def cpp_stl_example():
	import cython_lib.stl_cpp as stl_cpp
