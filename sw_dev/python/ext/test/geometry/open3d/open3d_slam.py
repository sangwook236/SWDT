...
def pose_graph_optimization_test():
...
#	https://github.com/isl-org/Open3D/blob/master/examples/python/t_reconstruction_system/dense_slam.py
def dense_slam_tutorial():
	def slam(depth_file_names, color_file_names, intrinsic, config):
		...
		for i in range(n_files):
			...
			model.synthesize_model_frame(
				raycast_frame, config.depth_scale,
