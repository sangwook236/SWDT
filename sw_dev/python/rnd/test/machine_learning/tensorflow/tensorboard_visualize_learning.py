# REF [site] >> https://www.tensorflow.org/get_started/summaries_and_tensorboard
# REF [file] >> https://github.com/tensorflow/tensorflow/blob/master/tensorflow/examples/tutorials/mnist/mnist_with_summaries.py
...
if __name__ == '__main__':
	...
	parser.add_argument('--data_dir', type=str, default='D:/dataset/pattern_recognition/mnist/download', help='Directory for storing input data')
	parser.add_argument('--log_dir', type=str, default='D:/dataset/pattern_recognition/mnist/logs', help='Summaries log directory')
