...
with graph1.as_default() as graph:
	...
	x1_1 = tf.constant(2, dtype=tf.float32, shape=[2, 3], name='x1_1')
	x1_2 = tf.constant(3, dtype=tf.float32, shape=[2, 3], name='x1_2')
	y1_1 = tf.sqrt(x1_1, name='y1_1')
	y1_2 = tf.sin(x1_2, name='y1_2')
	z1 = tf.add(y1_1, y1_2, name='z1')

	A1 = tf.constant(2, dtype=tf.float32, shape=(5, 10), name='A1')
	B1 = tf.constant(3, dtype=tf.float32, shape=(10, 3), name='B1')
...
with graph3.as_default() as graph:
	...
	x3_1 = tf.constant(2, dtype=tf.float32, shape=[2, 3], name='x3_1')
	x3_2 = tf.constant(3, dtype=tf.float32, shape=[2, 3], name='x3_2')
...
with sess2:
	...
	x2_1 = tf.constant(2, dtype=tf.float32, shape=[2, 3], name='x2_1')
	x2_2 = tf.constant(3, dtype=tf.float32, shape=[2, 3], name='x2_2')
	y2_1 = tf.sqrt(x2_1, name='y2_1')
	y2_2 = tf.sin(x2_2, name='y2_2')
	z2 = tf.add(y2_1, y2_2, name='z2')

	A2 = tf.constant(2, dtype=tf.float32, shape=(5, 10), name='A2')
	B2 = tf.constant(3, dtype=tf.float32, shape=(10, 3), name='B2')
	C2 = tf.matmul(A1, B1, name='C2')
...
with sess3:
	...
	A3 = tf.constant(2, dtype=tf.float32, shape=(5, 10), name='A3')
	B3 = tf.constant(3, dtype=tf.float32, shape=(10, 3), name='B3')
...
with sess3 as sess:
	...
	# NOTICE [caution] >> If tf.Tensor.eval() or tf.Session.run() is called in with statement, the session (sess3) will be closed in the end of with statement
	#print(C3.eval(session=sess))
	#print(sess.run(C3))

print(C3.eval(session=sess3))
print(sess3.run(C3))
