...
def transformer_tutorial():
	...
	d_hid = 200  # dimension of the feedforward network model in torch.nn.TransformerEncoder
	nlayers = 2  # number of torch.nn.TransformerEncoderLayer in torch.nn.TransformerEncoder
	nhead = 2  # number of heads in torch.nn.MultiheadAttention
