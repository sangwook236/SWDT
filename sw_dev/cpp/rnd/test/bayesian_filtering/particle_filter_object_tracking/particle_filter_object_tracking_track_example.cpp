...
{
	const std::string export_base("./bayesian_filtering/frame_");
...
void track_example()
{
	const std::string input_vided_file("./bayesian_filtering/hockey.avi");  // input video file name.
	//const std::string input_vided_file("./bayesian_filtering/soccer.avi");  // input video file name.
