...
// REF [file] >> ${COIN-OR_HOME}/COIN-OR/doc/cbcuserguide.html#firstexample
void cbc_simple_example()
{
	...
	// Print the solution.  CbcModel clones the solver so we need to get current copy from the CbcModel.
