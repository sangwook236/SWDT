...
int mainImage()
{
	...
	IpVec ipts;
	IplImage *img=cvLoadImage("./feature_analysis_data/opensurf/sf.jpg");
...
int mainVideo()
{
	...
	//cv::VideoWriter vw("./feature_analysis_data/opensurf/out.avi", CV_FOURCC('D','I','V','X'), 10, cvSize(320,240), 1);
	//vw << img;
...
int mainMatch()
{
	...
	// Replace the line below with IplImage *img = cvLoadImage("./feature_analysis_data/opensurf/object.jpg"); 
	// where object.jpg is the planar object to be located in the video
	IplImage *img = cvLoadImage("./feature_analysis_data/opensurf/object.jpg"); 
...
int mainStaticMatch()
{
	IplImage *img1 = cvLoadImage("./feature_analysis_data/opensurf/img1.jpg");
	IplImage *img2 = cvLoadImage("./feature_analysis_data/opensurf/img2.jpg");
...
int mainKmeans()
{
	IplImage *img = cvLoadImage("./feature_analysis_data/opensurf/img1.jpg");
	IpVec ipts;
	Kmeans km;
