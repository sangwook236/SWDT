...
#ifndef CUDA_STRERROR_CUDPP_H
#define CUDA_STRERROR_CUDPP_H

#include <cudpp.h>

/** \brief Convert CUDPPResult to human-readable string
 *	\param err CUDPPResult enum
 */
const char* strerror_cudpp(CUDPPResult err);

#endif /* CUDA_STRERROR_CUDPP_H */
