...
#ifndef CONVERTRGB2GRAYFLOATGPU_H
#define CONVERTRGB2GRAYFLOATGPU_H
 ...
 *
 *	The function reads 24-bit pixels from d_src and converts them to
 *	gray-scale values using the given shift parameters. The result is converted
 *	to float in the range [0.0, 1.0].
 */
void convertRGB2GrayFloatGPU(
...
#endif /* CONVERTRGB2GRAYFLOATGPU_H */
