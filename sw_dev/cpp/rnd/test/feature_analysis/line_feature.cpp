...
void lsd_image_test()
{
	...
	//const std::string filename("opencv_data\\hand_01_1.jpg");
	//const std::string filename("opencv_data\\hand_34.jpg");
	//const std::string filename("opencv_data\\hand_35.jpg");
	//const std::string filename("opencv_data\\hand_detection_ref_04_original.jpg");
	//const std::string filename("opencv_data\\hand_detection_ref_05_original.jpg");
