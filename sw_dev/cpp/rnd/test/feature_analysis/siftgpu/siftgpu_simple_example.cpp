...
void simple_example_1()
{
	...
	//
	{
		...
		if (sift.RunSIFT("./feature_analysis_data/sift/640-1.jpg"))
			sift.SaveSIFT("./feature_analysis_data/sift/640-1.sift");
		else
			std::cout << "SIFT features not found" << std::endl;

		// you can get the feature vector and store it yourself
		if (!sift.RunSIFT("./feature_analysis_data/sift/640-2.jpg"))
		{
			std::cout << "SIFT features not found" << std::endl;
			return;
		}
	...
	{
		const char * files[4] = { "./feature_analysis_data/sift/640-1.jpg", "./feature_analysis_data/sift/640-2.jpg", "./feature_analysis_data/sift/640-3.jpg", "./feature_analysis_data/sift/640-4.jpg" };
...
#	endif
    ...
    if (sift->RunSIFT("./feature_analysis_data/sift/800-1.jpg"))
    {
        // Call SaveSIFT to save result to file, the format is the same as Lowe's
        sift->SaveSIFT("./feature_analysis_data/sift/800-1.sift");  // Note that saving ASCII format is slow
	...
	//sift->SaveSIFT("./feature_analysis_data/sift/256.sift.1");
    //sift->RunSIFT("./feature_analysis_data/sift/1024.jpg");  // this will result in pyramid reallocation
    //sift->RunSIFT("./feature_analysis_data/sift/256.jpg");
	...
	//sift->SaveSIFT("./feature_analysis_data/sift/640-1.sift.3");
