...
{		
	...
	shogun::CModelSelectionParameters *cc1 = new shogun::CModelSelectionParameters("kernel_list", list);
	c5->append_child(cc1);
	...
	shogun::CModelSelectionParameters *cc6 = new shogun::CModelSelectionParameters("next", third);
...
// [ref] ${SHOGUN_HOME}/examples/undocumented/libshogun/regression_gaussian_process_sum.cpp
void regression_gaussian_process_sum_example()
{
	...
	shogun::CCombinedKernel *test_kernel = new shogun::CCombinedKernel();
