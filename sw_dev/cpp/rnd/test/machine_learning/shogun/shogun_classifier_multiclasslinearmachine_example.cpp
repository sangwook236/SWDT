...
// [ref] ${SHOGUN_HOME}/examples/undocumented/libshogun/classifier_multiclasslinearmachine.cpp
void classifier_multiclasslinearmachine_example()
{
	...
	shogun::CDenseFeatures<float64_t> *features = (CDenseFeatures<float64_t> *)stream_features->get_streamed_features(1000);
	...
	shogun::CLinearMulticlassMachine *mc_svm = new shogun::CLinearMulticlassMachine(new shogun::CMulticlassOneVsOneStrategy(), (shogun::CDotFeatures *)features, svm, labels);
	SG_REF(mc_svm);
