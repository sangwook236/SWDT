...
shogun::CModelSelectionParameters * build_tree(shogun::CInferenceMethod *inf, shogun::CLikelihoodModel *lik, shogun::CKernel *kernel)
{
	...
	c3->append_child(c4);
	c4->build_values(0.001, 4.0, shogun::R_LINEAR);
	...
	c5->append_child(c6);
	c6->build_values(0.001, 4.0, shogun::R_LINEAR);
...
// [ref] ${SHOGUN_HOME}/examples/undocumented/libshogun/regression_gaussian_process_gaussian.cpp
