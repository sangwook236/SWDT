...
// [ref] ${SHOGUN_HOME}/examples/undocumented/libshogun/classifier_multiclass_ecoc_discriminant.cpp
void classifier_multiclass_ecoc_discriminant_example()
{
    ...
    shogun::CECOCDiscriminantEncoder *encoder = new shogun::CECOCDiscriminantEncoder();
	...
	shogun::CLinearMulticlassMachine *mc_svm = new shogun::CLinearMulticlassMachine(new shogun::CECOCStrategy(encoder, new shogun::CECOCHDDecoder()), (shogun::CDotFeatures *)features, svm, labels);
	SG_REF(mc_svm);
