...
// [ref] ${SHOGUN_HOME}/examples/undocumented/libshogun/classifier_multiclass_ecoc_random.cpp
void classifier_multiclass_ecoc_random_example()
{
	...
	shogun::CLinearMulticlassMachine *mc_svm = new shogun::CLinearMulticlassMachine(new shogun::CECOCStrategy(new shogun::CECOCRandomDenseEncoder(), new shogun::CECOCHDDecoder()), (shogun::CDotFeatures *)features, svm, labels);
	SG_REF(mc_svm);
