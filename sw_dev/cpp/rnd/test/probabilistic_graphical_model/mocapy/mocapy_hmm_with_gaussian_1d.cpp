...
// [ref] ${MOCAPY_HOME}/examples/hmm_gauss_1d.cpp
void hmm_with_gaussian_1d()
{
	...
	covs.set_values(mocapy::vec(1.0, 2.0));
	...
	mocapy::Node *to0 = mocapy::NodeFactory::new_gaussian_node(O_SIZE, "to0", false, false, means, covs);
	...
	mocapy::Node *mo0 = mocapy::NodeFactory::new_gaussian_node(O_SIZE, "mo0", true);
