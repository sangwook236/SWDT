...
void human_detection_using_hog()
{
	...
	filenames.push_back("opencv_data\\human_01.jpg");
	filenames.push_back("opencv_data\\human_02.jpg");
	filenames.push_back("opencv_data\\human_03.jpg");
	filenames.push_back("opencv_data\\human_04.jpg");
	filenames.push_back("opencv_data\\human_05.jpg");
	filenames.push_back("opencv_data\\human_06.jpg");
	filenames.push_back("opencv_data\\human_07.jpg");
	filenames.push_back("opencv_data\\human_08.jpg");
