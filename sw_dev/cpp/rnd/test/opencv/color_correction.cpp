...
{
#if 0
	const std::string filename("opencv_data\\color_correction_0.png");
...
#elif 1
	const std::string filename("opencv_data\\color_correction_1.jpg");
...
#elif 0
	const std::string filename("opencv_data\\color_correction_2.jpg");
	const int PATCH_WIDTH = 450, PATCH_HEIGHT = 450;
	const int WHITE_BALANCE_PATCH_NUM = 3;
	const int COLOR_CORRECTION_PATCH_NUM = 3;
	const int PATCH_NUM = WHITE_BALANCE_PATCH_NUM + COLOR_CORRECTION_PATCH_NUM;
	...
	const cv::Rect blueRect(1870, 1210, PATCH_WIDTH, PATCH_HEIGHT);
#elif 0
	const std::string filename("opencv_data\\color_correction_3.jpg");
	const int PATCH_WIDTH = 450, PATCH_HEIGHT = 450;
	const int WHITE_BALANCE_PATCH_NUM = 3;
	const int COLOR_CORRECTION_PATCH_NUM = 3;
	const int PATCH_NUM = WHITE_BALANCE_PATCH_NUM + COLOR_CORRECTION_PATCH_NUM;
