...
void face_detection()
{
	const std::string face_cascade_filename = "opencv_data/haarcascades/haarcascade_frontalface_alt.xml";  // Haar-like feature
	//const std::string face_cascade_filename = "opencv_data/lbpcascades/lbpcascade_frontalface.xml";  // LBP feature
	const std::string eyes_cascade_filename = "opencv_data/haarcascades/haarcascade_eye_tree_eyeglasses.xml";
