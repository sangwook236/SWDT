...
void feature_description()
{
	...
	const std::string modelFilename("opencv_data\\fern_model.xml.gz");
	const std::string trainImagesFilename("opencv_data\\calonder_train_images_filename.txt");
	const std::string classifierFilename("opencv_data\\calonder_classfier.txt");
#elif 0
	...
	{
		//sift(img1, img2, keypoints1, keypoints2, descriptors1, descriptors2, matches);
		//surf(img1, img2, keypoints1, keypoints2, descriptors1, descriptors2, matches);
		//train_calonder_classifier(featureDetector, trainImagesFilename, classifierFilename);
		calonder(classifierFilename, img1, img2, keypoints1, keypoints2, descriptors1, descriptors2, matches);
		//brief(img1, img2, keypoints1, keypoints2, descriptors1, descriptors2, matches);
		//fern(modelFilename, img1, img2);
	}
