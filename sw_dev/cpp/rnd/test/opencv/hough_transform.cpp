...
{
	const std::string imageFileName("opencv_data\\hough_line.png");
	...
	//
	//hough_line_standard(srcImage, grayImage);
	//hough_line_probabilistic(srcImage, grayImage);
	hough_circle(srcImage, grayImage);
