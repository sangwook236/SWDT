...
void show_image()
{
	const char *winName = "opencv_data\\Image:";
	const char *imgName = "opencv_data\\lena_gray.bmp";
	const char *savedImgName = "opencv_data\\lena_gray_edge.png";
...
{
	const std::string img1_name("opencv_data\\table_only.jpg");
	const std::string img2_name("opencv_data\\table_hand_01.jpg");
	//const std::string img2_name("opencv_data\\table_hand_02.jpg");
	//const std::string img2_name("opencv_data\\table_hand_03.jpg");
	//const std::string img2_name("opencv_data\\table_hand_04.jpg");
	//const std::string img2_name("opencv_data\\table_hand_05.jpg");
