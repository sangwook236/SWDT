...
//const std::string img1_filename = "opencv_data\\synthesized_training_image1.bmp";
//const std::string img2_filename = "opencv_data\\synthesized_training_image2.bmp";
//const std::string img2_filename = "opencv_data\\synthesized_training_image3.bmp";
//const std::string img1_filename = "opencv_data\\synthesized_testing_image1.bmp";
//const std::string img2_filename = "opencv_data\\synthesized_testing_image2.bmp";
//const std::string img2_filename = "opencv_data\\synthesized_testing_image3.bmp";
const std::string img1_filename = "opencv_data\\sample3_01.jpg";
const std::string img2_filename = "opencv_data\\sample3_02.jpg";
...
#else
	const std::string avi_filename("opencv_data\\tree.avi");
