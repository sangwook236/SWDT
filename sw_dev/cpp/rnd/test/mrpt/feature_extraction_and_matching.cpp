...
void extract_features(const mrpt::utils::CMRPTImage &img, const unsigned int mode, mrpt::vision::CFeatureList &features)
{
	...
	if ((0x01 & mode) == 0x01)
	{
		...
		features.saveToTextFile(".\\mrpt_data\\feature\\feature_harris.txt");
	}
	...
	if ((0x02 & mode) == 0x02)
	{
		...
		features.saveToTextFile(".\\mrpt_data\\feature\\feature_harris+sift.txt");
	}
	...
	if ((0x04 & mode) == 0x04)
	{
		...
		features.saveToTextFile(".\\mrpt_data\\feature\\feature_klt.txt");
	}
	...
	if ((0x08 & mode) == 0x08)
	{
		...
		features.saveToTextFile(".\\mrpt_data\\feature\\feature_sift_hess.txt");
	}
	...
	if ((0x10 & mode) == 0x10)
	{
		...
		features.saveToTextFile(".\\mrpt_data\\feature\\feature_surf.txt");
	}
	...
	if ((0x20 & mode) == 0x20)
	{
		...
		features.saveToTextFile(".\\mrpt_data\\feature\\feature_harris+spinimgs.txt");
	}
	...
	if ((0x40 & mode) == 0x40)
	{
		...
		features.saveToTextFile(".\\mrpt_data\\feature\\feature_harris+sift+spinimgs.txt");
	}
}
...
void feature_extraction_and_matching()
{
	...
	if (false)
	{
		//const std::string imageFileName(".\\mrpt_data\\feature\\test_image.jpg");
		const std::string imageFileName(".\\mrpt_data\\feature\\feature_matching_test_1.jpg");
		//const std::string imageFileName(".\\mrpt_data\\feature\\feature_matching_test_2.jpg");
	...
	if (true)
	{
		const std::string imageFileName1(".\\mrpt_data\\feature\\feature_matching_test_1.jpg");
		const std::string imageFileName2(".\\mrpt_data\\feature\\feature_matching_test_2.jpg");
/*
		{
			mrpt::utils::CMRPTImage img1, img2;
