...
{
	const std::string GRID_MAP_FILE(".\\mrpt_data\\2006-MalagaCampus.gridmap.gz");
	const std::string IMAGE_DEST_FILE(".\\mrpt_data\\path_planning.png");
...
void path_planning_2()
{
	...
	const std::string mapImageFileName(".\\mrpt_data\\KAIST_DemoFile.bmp");
