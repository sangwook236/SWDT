...
{
	const std::string simpleMapInputFileName(".\\mrpt_data\\localization_pf\\localization_demo.simplemap.gz");
	const std::string simpleMapOutputFileName(".\\mrpt_data\\map_handling.simplemap.gz");
	const std::string gridMapInputFileName(".\\mrpt_data\\2006-MalagaCampus.gridmap.gz");
	const std::string mapImageFileName(".\\mrpt_data\\KAIST-EECS-2ND-INTERSECTION.jpg");
	const std::string metricMapOutputPrefix(".\\mrpt_data\\metric_maps");
	const std::string metricMapConfigFileName(".\\mrpt_data\\metric_maps_config.ini");
...
{
	const std::string mapImageFileName(".\\mrpt_data\\PIRO_1st_floor_map_GC2009_final.bmp");
