...
void generic_description_and_matching()
{
	...
	const std::string algorithm_params_filename("machine_vision_data\\opencv\\fern_params.xml");
	...
	cv::Mat img_corr;
	local::drawCorrespondences(img1, keypoints1, img2, keypoints2, matches2to1, img_corr);
