...
void normal_mixture_example()
{
	...
	const std::string dataFileName("./data/statistics/mcmcpp/normal_mixture.txt");  // TODO [check] >> is a data file correct?
	const std::string logFileName("./data/statistics/mcmcpp/normal_mixture_log.txt");
