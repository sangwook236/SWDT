...
void segment_sample(const bool use_map_container)
{
	...
	const std::string output_filename("./data/segmentation/beach_segmented.ppm");
	const float sigma = 0.5f;
	const float k = 500.0f;
	const int min_size = 50;
#elif 0
	const std::string input_filename("./data/segmentation/grain.ppm");
	const std::string output_filename("./data/segmentation/grain_segmented.ppm");
	const float sigma = 0.5f;
	const float k = 1000.0f;
	const int min_size = 100;
#elif 1
	//const std::string input_filename("../hw_interface/bin/data/kinect/kinect_rgba_20130530T103805.ppm");
	//const std::string input_filename("../hw_interface/bin/data/kinect/kinect_rgba_20130531T023152.ppm");
	//const std::string input_filename("../hw_interface/bin/data/kinect/kinect_rgba_20130531T023346.ppm");
	//const std::string input_filename("../hw_interface/bin/data/kinect/kinect_rgba_20130531T023359.ppm");
	const std::string input_filename("./data/segmentation/rectified_image_rgb_0.ppm");
	const std::string output_filename("./data/segmentation/kinect_segmented.ppm");
	const float sigma = 0.5f;
	const float k = 500.0f;
	const int min_size = 50;
#endif
...
#if 1
	const std::string input_filename("./data/segmentation/rectified_image_rgb_0.ppm");
	const std::string depth_filename("./data/segmentation/depth_guided_mask_0.ppm");
	const std::string output_filename("./data/segmentation/segmented_image_rgb_0.ppm");
#elif 0
	const std::string input_filename("./data/segmentation/rectified_image_rgb_1.ppm");
	const std::string depth_filename("./data/segmentation/depth_guided_mask_1.ppm");
	const std::string output_filename("./data/segmentation/segmented_image_rgb_1.ppm");
#elif 0
	const std::string input_filename("./data/segmentation/rectified_image_rgb_2.ppm");
	const std::string depth_filename("./data/segmentation/depth_guided_mask_2.ppm");
	const std::string output_filename("./data/segmentation/segmented_image_rgb_2.ppm");
#elif 0
	const std::string input_filename("./data/segmentation/rectified_image_rgb_3.ppm");
	const std::string depth_filename("./data/segmentation/depth_guided_mask_3.ppm");
	const std::string output_filename("./data/segmentation/segmented_image_rgb_3.ppm");
#endif
	const float sigma = 0.5f;
	const float k = 500.0f;
	const int min_size = 50;
