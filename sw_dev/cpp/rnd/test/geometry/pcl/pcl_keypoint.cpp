...
void setViewerPose (pcl::visualization::PCLVisualizer &viewer, const Eigen::Affine3f &viewer_pose)
{
	...
	const Eigen::Vector3f up_vector(viewer_pose.rotation() * Eigen::Vector3f(0, -1, 0));
...
// REF [site] >> https://pcl.readthedocs.io/projects/tutorials/en/latest/narf_keypoint_extraction.html
void narf_keypoint_tutorial()
{
	...
	//	range_image_widget.markPoint(keypoint_indices[i] % range_image.width, keypoint_indices[i] / range_image.width);
