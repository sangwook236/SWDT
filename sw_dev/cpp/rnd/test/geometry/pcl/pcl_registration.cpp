...
void registration_example()
{
	...
	std::cout << "Loaded " << cloud1->width * cloud1->height << " data points from " << input_filename1 << " with the following fields:" << std::endl;
	//for (const auto &point: *cloud1)
	//	std::cout << '\t' << point.x << ", " << point.y << ", " << point.z << std::endl;
	std::cout << "Loaded " << cloud2->width * cloud2->height << " data points from " << input_filename2 << " with the following fields:" << std::endl;
	...
	std::cout << "Point cloud aligned: " << std::chrono::duration_cast<std::chrono::milliseconds>(elapsed_time).count() / 1000.0f << " secs." << std::endl;
