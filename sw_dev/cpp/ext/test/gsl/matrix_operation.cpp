...
void matrix_basic()
{
	...
	std::cout << std::endl << ">>> row & column of matrix" << std::endl;
	{
		...
		print_gsl_vector(&row.vector);
		print_gsl_vector(&col.vector);
		print_gsl_vector(&diag.vector);
