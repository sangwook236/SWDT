...
void draw_arm(const double L1, const double W1, const double L2, const double W2, const double theta1, const double theta2, const int index)
{
	...
	cairo_surface_t *surface = cairo_svg_surface_create(".\\cairo_data\\two_link_arm.svg", (double)WIDTH, (double)HEIGHT);
	...
	sstream << ".\\cairo_data\\two_link_arm_" << std::setfill('0') << std::setw(2) << index << ".png";
