...
void draw_ellipse()
{
	...
	cairo_surface_t *surface = cairo_svg_surface_create(".\\cairo_data\\basic_drawing_1.svg", (double)width, (double)height);
#elif defined(CAIRO_HAS_IMAGE_SURFACE)
	cairo_surface_t *surface = cairo_image_surface_create(CAIRO_FORMAT_ARGB32, width, height);
#elif defined(CAIRO_HAS_PDF_SURFACE)
	cairo_surface_t *surface = cairo_pdf_surface_create(".\\cairo_data\\basic_drawing_1.pdf", (double)width, (double)height);
	...
	// save to a png file
	cairo_surface_write_to_png(surface, ".\\cairo_data\\basic_drawing_1_out.png");
