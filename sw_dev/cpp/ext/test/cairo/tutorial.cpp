...
void tutorial_1()
{
	...
	cairo_surface_t *surface = cairo_svg_surface_create(".\\cairo_data\\tutorial_1.svg", (double)width, (double)height);
#elif defined(CAIRO_HAS_IMAGE_SURFACE)
	cairo_surface_t *surface = cairo_image_surface_create(CAIRO_FORMAT_ARGB32, width, height);
#elif defined(CAIRO_HAS_PDF_SURFACE)
	cairo_surface_t *surface = cairo_pdf_surface_create(".\\cairo_data\\tutorial_1.pdf", (double)width, (double)height);
	...
	// save to a png file
	cairo_surface_write_to_png(surface, ".\\cairo_data\\tutorial_1_out.png");
...
void tutorial_2()
{
...
#if defined(CAIRO_HAS_SVG_SURFACE)
	cairo_surface_t *surface = cairo_svg_surface_create(".\\cairo_data\\tutorial_2.svg", (double)width, (double)height);
#elif defined(CAIRO_HAS_IMAGE_SURFACE)
	cairo_surface_t *surface = cairo_image_surface_create(CAIRO_FORMAT_ARGB32, width, height);
#elif defined(CAIRO_HAS_PDF_SURFACE)
	cairo_surface_t *surface = cairo_pdf_surface_create(".\\cairo_data\\tutorial_2.pdf", (double)width, (double)height);
#elif defined(CAIRO_HAS_WIN32_SURFACE)
	cairo_surface_t *surface = cairo_win32_surface_create(hdc);
	//cairo_surface_t *surface = cairo_win32_surface_create_with_dib(CAIRO_FORMAT_ARGB32, width, height);
	//cairo_surface_t *surface = cairo_win32_surface_create_with_ddb(CAIRO_FORMAT_ARGB32, width, height);
	...
	cairo_save(cr);
	{
		...
		cairo_surface_t *img = cairo_image_surface_create_from_png(".\\cairo_data\\pattern_1.png");
	...
	// save to a png file
	cairo_surface_write_to_png(surface, ".\\cairo_data\\tutorial_2_out.png");
...
void tutorial_3()
{
...
#if defined(CAIRO_HAS_SVG_SURFACE)
	cairo_surface_t *surface = cairo_svg_surface_create(".\\cairo_data\\tutorial_3.svg", (double)width, (double)height);
#elif defined(CAIRO_HAS_IMAGE_SURFACE)
	cairo_surface_t *surface = cairo_image_surface_create(CAIRO_FORMAT_ARGB32, width, height);
#elif defined(CAIRO_HAS_PDF_SURFACE)
	cairo_surface_t *surface = cairo_pdf_surface_create(".\\cairo_data\\tutorial_3.pdf", (double)width, (double)height);
#elif defined(CAIRO_HAS_WIN32_SURFACE)
	cairo_surface_t *surface = cairo_win32_surface_create(hdc);
	//cairo_surface_t *surface = cairo_win32_surface_create_with_dib(CAIRO_FORMAT_ARGB32, width, height);
	//cairo_surface_t *surface = cairo_win32_surface_create_with_ddb(CAIRO_FORMAT_ARGB32, width, height);
	...
	// save to a png file
	cairo_surface_write_to_png(surface, ".\\cairo_data\\tutorial_3_out.png");
