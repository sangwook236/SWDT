...
void diagram (char *name, double *alpha)
{
	...
	const std::string svg_filename(std::string("./cairo_data/") + std::string(name) + std::string(".svg"));
	const std::string png_filename(std::string("./cairo_data/") + std::string(name) + std::string(".png"));
