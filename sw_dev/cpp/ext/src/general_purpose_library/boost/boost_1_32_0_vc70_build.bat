...
set VC7_ROOT="F:\Program Files\Microsoft Visual Studio .NET\Vc7"
...
set TOOLS=vc7-stlport

bjam --prefix=%BOOST_PREFIX_DIR% "-sTOOLS=vc7-stlport" "-sBUILD=debug release <native-wchar_t>on <runtime-link>static/dynamic <threading>single/multi <stlport-iostream>on <stlport-cstd-namespace>std" %1%
