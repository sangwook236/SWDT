...
# bjam {stage/install/clean} debug release --toolset=gcc optimization={off/full/space/speed} link=static,shared threading=single,multi runtime-link=single,shared --build-type=complete
