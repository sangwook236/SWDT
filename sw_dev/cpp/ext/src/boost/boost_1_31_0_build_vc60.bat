...
bjam --prefix=%BOOST_PREFIX_DIR% "-sTOOLS=msvc-stlport" "-sBUILD=debug release <runtime-link>static/dynamic <threading>multiple <stlport-iostream>on <stlport-cstd-namespace>std" %1%
